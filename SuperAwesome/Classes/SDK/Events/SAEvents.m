...
//    NSDictionary *data = @{
//        @"level1": @"SuperAwesome",
//        @"level2": [NSString stringWithFormat:@"%ld", (long)ad.campaignId],
//        @"level3": [NSString stringWithFormat:@"%ld", (long)ad.lineItemId],
//        @"level4": [NSString stringWithFormat:@"%ld", (long)ad.creative.creativeId],
//        @"slicer1": [NSString stringWithFormat:@"%ld", (long)ad.appId],
//        @"slicer2": [NSString stringWithFormat:@"%ld", (long)ad.placementId]
//    };
//    
