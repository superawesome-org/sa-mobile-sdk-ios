...
SWIFT_PROTOCOL_NAMED("ComponentModuleType")
@protocol SAComponentModuleType
@property (nonatomic, readonly, strong) id <SADeviceType> _Nonnull device;
@property (nonatomic, readonly, strong) id <SAUserAgentType> _Nonnull userAgent;
@end
...
@protocol SAModuleContainerType;

SWIFT_CLASS_NAMED("DependencyContainer")
@interface SADependencyContainer : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SADependencyContainer * _Null_unspecified shared;)
+ (SADependencyContainer * _Nullable)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)initModules:(id <SAModuleContainerType> _Nonnull)modules SWIFT_METHOD_FAMILY(none);
@property (nonatomic, readonly, strong) id <SAModuleContainerType> _Nonnull modules;
- (nonnull instancetype)initWith:(id <SAModuleContainerType> _Nonnull)moduleContainer OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_PROTOCOL_NAMED("DeviceType")
@protocol SADeviceType
...
SWIFT_PROTOCOL_NAMED("Injectable")
@protocol SAInjectable
@property (nonatomic, readonly, strong) id <SAModuleContainerType> _Nonnull dependencies;
@end

@protocol SARepositoryModuleType;

SWIFT_PROTOCOL_NAMED("ModuleContainerType")
@protocol SAModuleContainerType
@property (nonatomic, readonly, strong) id <SAComponentModuleType> _Nonnull componentModule;
@property (nonatomic, readonly, strong) id <SARepositoryModuleType> _Nonnull repositoryModule;
@end


SWIFT_CLASS_NAMED("ModuleContainer")
@interface SAModuleContainer : NSObject <SAModuleContainerType>
@property (nonatomic, strong) id <SARepositoryModuleType> _Nonnull repositoryModule;
@property (nonatomic, strong) id <SAComponentModuleType> _Nonnull componentModule;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end



SWIFT_PROTOCOL_NAMED("RepositoryModuleType")
@protocol SARepositoryModuleType
@property (nonatomic, readonly, strong) id <SADataRepositoryType> _Nonnull dataRepository;
@end
