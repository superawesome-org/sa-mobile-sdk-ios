Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "8.0"
  s.requires_arc = true
  s.source       = { :git => "https://github.com/SuperAwesomeLTD/sa-mobile-sdk-ios.git", :branch => "master" ,:tag => "5.7.0" }
  ...
  s.subspec 'Base' do |b|
    ...
    b.dependency 'SAWebPlayer', '1.2.1'
    b.dependency 'SAEvents', '1.9.2'
    b.dependency 'SAAdLoader', '1.1.2'
    b.dependency 'SACPI', '1.0.8'
  end
