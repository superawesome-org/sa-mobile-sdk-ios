...
func makeAdRequest() -> AdRequest {
    AdRequest(test: false, pos: .aboveTheFold, skip: .no, playbackmethod: 10,
              startdelay: .genericMidRoll, instl: .off, w: 25, h: 35)
}
...
func makeAdResponse() -> AdResponse {
