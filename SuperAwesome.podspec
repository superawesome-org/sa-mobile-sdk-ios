Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "8.0"
  s.requires_arc = true
  s.source       = { :git => "https://github.com/SuperAwesomeLTD/sa-mobile-sdk-ios.git", :branch => "master" ,:tag => "5.7.1" }
  s.default_subspec = 'Full'

  s.subspec 'Base' do |b|
    b.source_files = 'Pod/Classes/**/*'
    b.frameworks = 'AdSupport'
    b.dependency 'SAVideoPlayer', '1.2.2'
    b.dependency 'SAWebPlayer', '1.2.2'
    b.dependency 'SAEvents', '1.9.3'
    b.dependency 'SAAdLoader', '1.1.3'
    b.dependency 'SACPI', '1.0.9'
  end
