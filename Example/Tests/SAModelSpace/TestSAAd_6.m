...
- (void)setUp {
    ...
    NSString *given = [_utils stringFixtureWithName:@"mock_ad_response_5" ofType:@"json"];
...
- (void) test_SACreative {
    ...
    NSString *expected_creative_bundle = @"tv.superawesome.KWSDemo";
