...
@available(*, deprecated, renamed: "BannerView" )
public final class SABannerAd: BannerView {
    private var listener: SADelegate?

    @available(*, deprecated, renamed: "setCallback" )
    public func setListener(listener: SADelegate) {
