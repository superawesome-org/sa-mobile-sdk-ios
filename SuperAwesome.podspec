Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source       = { :git => "https://github.com/SuperAwesomeLTD/sa-mobile-sdk-ios.git", :branch => "master" ,:tag => "5.2.6" }
  s.default_subspec = 'Full'

  s.subspec 'Base' do |b|
    b.source_files = 'Pod/Classes/**/*'
    b.frameworks = 'AdSupport'
    b.dependency 'SAVideoPlayer', '1.1.7'
    b.dependency 'SAWebPlayer', '1.1.0'
    b.dependency 'SAEvents', '1.6.0'
    b.dependency 'SAAdLoader', '0.7.8'
  end
